...
var handler = {
  ...
  changeTodos: function() {
    var todoChangePositionInput = document.getElementById(
      "todoChangePositionInput"
    );
  ...
  deleteTodos: function() {
    var todoDeletePositionInput = document.getElementById(
      "todoDeletePositionInput"
    );
  ...
  toggleCompleted: function() {
    var todoTogglePositionInput = document.getElementById(
      "todoTogglePositionInput"
    );
